...
#### DATA IMPORT ####
data_import = pd.read_csv('/Users/ildem/Desktop/DataViz_Streamlit_PW5_T1-main/data/HR_Data_cleaned.csv')
...
ax.set(xlabel = 'Years of Experience', ylabel = 'Probability', xlim = (0, 21), ylim=(0, 1))
...
st.header('How likely it is to look for a new job?')
